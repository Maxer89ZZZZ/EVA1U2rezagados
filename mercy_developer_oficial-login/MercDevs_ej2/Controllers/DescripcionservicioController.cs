...
namespace MercDevs_ej2.Controllers
{
    public class DescripcionservicioController : Controller
    {
        ...
        public async Task<IActionResult> DescripcionServicio(int? id)
        {
            var descripcion = _context.Descripcionservicios
                                        .Where(m => m.IdDescServ == id);
            return View(await descripcion.ToListAsync());
        }
        ...
        public async Task<IActionResult> Descrip(int? id)
        {

            var servicios = _context.Descripcionservicios
                .Where(u => u.ServicioIdServicio == id)
                .Include(d => d.ServicioIdServicioNavigation).ToListAsync();
            
            return View(await servicios);
        }
